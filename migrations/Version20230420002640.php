 ...
 */
final class Version20230420002640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE acts_invoice_basket ADD date VARCHAR(20) DEFAULT NULL');
        ...
        $this->addSql('DROP INDEX IDX_61D6B1C4E05387EF ON lab');
        $this->addSql('ALTER TABLE lab DROP assistant_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE acts_invoice_basket DROP date');
        $this->addSql('ALTER TABLE consultation CHANGE followed followed LONGTEXT DEFAULT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE lab ADD assistant_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE lab ADD CONSTRAINT FK_61D6B1C4E05387EF FOREIGN KEY (assistant_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_61D6B1C4E05387EF ON lab (assistant_id)');
