 ...
 */
final class Version20230221052407 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nursing_treatment_medicine ADD CONSTRAINT FK_AF9A81912F7D140A FOREIGN KEY (medicine_id) REFERENCES medicine (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE nursing_treatment_medicine ADD CONSTRAINT FK_AF9A819134ABBA2C FOREIGN KEY (nursing_treatment_id) REFERENCES nursing_treatment (id) ON UPDATE NO ACTION ON DELETE CASCADE');
    }
}
