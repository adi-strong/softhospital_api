 ...
 */
final class Version20230207184639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE covenant ADD CONSTRAINT FK_F4EB80F7AB8EAE4A FOREIGN KEY (pdf_object_id) REFERENCES pdf_object (id)');
