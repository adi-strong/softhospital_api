...
use App\Repository\TreatmentCategoryRepository;
...
#[ORM\Entity(repositoryClass: TreatmentCategoryRepository::class)]
#[ApiResource(
  types: ['https://schema.org/TreatmentCategory'],
  operations: [
    new GetCollection(),
    new Get(),
    new Post(),
  ...
  normalizationContext: ['groups' => ['treatmentCategory:read']],
  order: ['id' => 'DESC'],
...
class TreatmentCategory
{
  use CreatedAtTrait;
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['treatmentCategory:read', 'treatment:read'])]
    private ?int $id = null;
    ...
    #[ORM\ManyToOne(inversedBy: 'treatmentCategories')]
    private ?Hospital $hospital = null;

    #[ORM\OneToMany(mappedBy: 'category', targetEntity: Treatment::class)]
